...
The simulated result aligns with our calculation.

Here we visualize the convergence of probability as the # of trials increases:

```{r conv_by_trial}
source("../src/conv_by_trials.r")
```

And the probability decreases when there are more ducks fall into the circle:
